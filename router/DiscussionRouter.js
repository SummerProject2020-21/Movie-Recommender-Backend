        ...
        try{
            ...
            if(!(title==="" || description==="")){
                ...
                if(user!=null){
                    ...
                    return res.status(200).send({message: "Success", discussion: savedDiscussion});
                }else{
...
discussionRouter.get(
    ...
    expressAsyncHandler(async(req,res)=>{
        try{
            ...
            return res.status(200).send({message:"Success",discussions: discussions});
        }catch(err){
            console.log(err);
            return res.status(500).send({message:"Internal server error!"})
        }
...
discussionRouter.get(
    ...
    expressAsyncHandler(async(req,res)=>{
        try{
            ...
            if(discussion!=null){
                return res.status(200).send({message: "Success",discussion: discussion});
            }else{
    ...
    expressAsyncHandler(async(req,res)=>{
        try{
            ...
            if(discussion!=null){
                ...
                if(user!=null){
                    ...
                    if(isDisliked!=-1){
                        ...
                        if(isLiked==-1){
                            ...
                            return res.status(401).send({message:"Already liked this discussion."})
                        }
                    }
                ...
                return res.status(404).send({message: "Given discussion doesn't exist"});
            }
        }catch(err){
            console.log(err);
            return res.status(500).send({message:"Internal server error!"})
                ...
                if(user!=null){
                    ...
                    if(isLiked!=-1){
                        ...
                        if(isDisliked==-1){
                            ...
                            return res.status(401).send({message:"Already disliked this discussion."})
                        }
                    }
